        ...
        <div class="flex flex-col gap-4 max-w-md">
            <div class="flex items-center gap-3">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <p class="mt-0.5 text-sm font-medium text-gray-900 truncate">{{ $email }}</p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <p class="mt-0.5 text-sm font-medium text-gray-900">{{ $phone }}</p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <p class="mt-0.5 text-sm font-medium text-gray-900">{{ $address }}</p>
                </div>
            </div>
        </div>
    </div>

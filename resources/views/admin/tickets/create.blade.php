<x-admin-layout>
    <x-slot name="header">
        ...
        <p class="mt-1 text-sm text-gray-500">Record a subscriber's problem so a technical staff member can pick it up.</p>
    </x-slot>
        ...
        <form method="POST" action="{{ route('admin.tickets.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="4" required
                    placeholder="What the subscriber reported, any troubleshooting already tried, etc."
